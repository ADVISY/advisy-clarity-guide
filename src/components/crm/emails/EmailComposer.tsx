...
import { Send, Users, User, FileText, Search, X, Loader2 } from "lucide-react";
...
export const EmailComposer = () => {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                {selectedClients.length > 0 ? (
                  ...
                  <p className="text-sm text-muted-foreground p-3 border rounded-lg">
                    Aucun destinataire sélectionné. Utilisez le panneau de droite pour sélectionner des clients.
                  </p>
                )}
              </div>
            )}
      ...
      {/* Client Selection Panel (for bulk mode) */}
      {mode === "bulk" && (
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent>
            <div className="border rounded-lg p-4 bg-white dark:bg-muted">
              <p className="font-medium mb-2">{subject || "Sans sujet"}</p>
              <div
